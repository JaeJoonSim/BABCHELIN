...
Shader "Screen Damage Effect"
{
	Properties
	{
		...
		[ASEBegin]_Speed("Speed", Range( 0 , 5)) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				half4 lerpResult50 = lerp( color53 , tex2D( _TextureSample0, uv_TextureSample0 ) , pow( saturate( ( ( 1.0 - length( ( ( IN.ase_texcoord3.xy - temp_cast_0 ) * 2.0 ) ) ) + (_Vector0.x + (sin( ( pow( ( frac( ( _TimeParameters.x * _Speed ) ) - _10 ) , _p ) * PI ) ) - 0.0) * (_Vector0.y - _Vector0.x) / (1.0 - 0.0)) ) ) , _power ));
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = lerpResult50.rgb;
				float Alpha = lerpResult50.r;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				half2 temp_cast_0 = (0.5).xx;
				half2 _Vector0 = half2(1,0.5);
				half4 lerpResult50 = lerp( color53 , tex2D( _TextureSample0, uv_TextureSample0 ) , pow( saturate( ( ( 1.0 - length( ( ( IN.ase_texcoord2.xy - temp_cast_0 ) * 2.0 ) ) ) + (_Vector0.x + (sin( ( pow( ( frac( ( _TimeParameters.x * _Speed ) ) - _10 ) , _p ) * PI ) ) - 0.0) * (_Vector0.y - _Vector0.x) / (1.0 - 0.0)) ) ) , _power ));
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				half2 temp_cast_0 = (0.5).xx;
				half2 _Vector0 = half2(1,0.5);
				half4 lerpResult50 = lerp( color53 , tex2D( _TextureSample0, uv_TextureSample0 ) , pow( saturate( ( ( 1.0 - length( ( ( IN.ase_texcoord.xy - temp_cast_0 ) * 2.0 ) ) ) + (_Vector0.x + (sin( ( pow( ( frac( ( _TimeParameters.x * _Speed ) ) - _10 ) , _p ) * PI ) ) - 0.0) * (_Vector0.y - _Vector0.x) / (1.0 - 0.0)) ) ) , _power ));
				

				surfaceDescription.Alpha = lerpResult50.r;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				half2 temp_cast_0 = (0.5).xx;
				half2 _Vector0 = half2(1,0.5);
				half4 lerpResult50 = lerp( color53 , tex2D( _TextureSample0, uv_TextureSample0 ) , pow( saturate( ( ( 1.0 - length( ( ( IN.ase_texcoord1.xy - temp_cast_0 ) * 2.0 ) ) ) + (_Vector0.x + (sin( ( pow( ( frac( ( _TimeParameters.x * _Speed ) ) - _10 ) , _p ) * PI ) ) - 0.0) * (_Vector0.y - _Vector0.x) / (1.0 - 0.0)) ) ) , _power ));
...
Node;AmplifyShaderEditor.RangedFloatNode;49;777.8354,430.0714;Inherit;False;Property;_power;power;1;0;Create;True;0;0;0;False;0;False;5;5;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;26;-1120.308,58.76802;Half;False;Property;_Speed;Speed;0;0;Create;True;0;0;0;False;0;False;1;1;0;5;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=656F2D0524C8B194DF95F4B3EC9B37E0D661996F