...
Shader "Deffect/S_Campfire1"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_T_Icesmoke("T_Icesmoke", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				half2 uv_T_Icesmoke = IN.ase_texcoord3.xy * _T_Icesmoke_ST.xy + _T_Icesmoke_ST.zw;
				half2 uv_TextureSample0 = IN.ase_texcoord3.xy * _TextureSample0_ST.xy + _TextureSample0_ST.zw;
				#ifdef _KEYWORD0_ON
				float staticSwitch16 = IN.ase_texcoord3.z;
				#else
				...
				float3 Color = ( IN.ase_color * ( _TintColor * ( _MainIns * ( tex2D( _T_Icesmoke, uv_T_Icesmoke ).r * saturate( ( tex2D( _TextureSample0, uv_TextureSample0 ).r + staticSwitch16 ) ) ) ) ) ).rgb;
...
Node;AmplifyShaderEditor.RangedFloatNode;11;-5109.204,-248.1352;Float;False;Property;_Dissolve;Dissolve;4;0;Create;True;0;0;0;False;0;False;-0.04948299;0;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;16;-4822.463,-227.7043;Float;False;Property;_Keyword0;Keyword 0;5;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;14;-4984.505,-621.9733;Inherit;False;0;1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;10;-4584.21,-382.5196;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;1;-4691.619,-634.8;Inherit;True;Property;_T_Icesmoke;T_Icesmoke;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;4;-4487.563,-713.8932;Float;False;Property;_MainIns;Main Ins;1;0;Create;True;0;0;0;False;0;False;1;0;1;50;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;5;-4192.908,-802.3421;Float;False;Property;_TintColor;Tint Color;2;0;Create;True;0;0;0;False;0;False;1,1,1,1;0,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;19;3;7;4
ASEEND*/
//CHKSM=C30D8B05C207FB3E3404BD089A0A43953D139970