	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 Color = ( ( _Color * ( IN.ase_color * tex2DNode10.r ) ) * _Inten ).rgb;
				float Alpha = ( tex2DNode10.a * tex2D( _Alpha_Tex, uv_Alpha_Tex ).r );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = ( tex2DNode10.a * tex2D( _Alpha_Tex, uv_Alpha_Tex ).r );
