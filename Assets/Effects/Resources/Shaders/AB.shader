	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 appendResult6 = (float4(_MainUPanner , _MainVPanner , 0.0 , 0.0));
				float2 uv_MainTexture = IN.ase_texcoord3.xy * _MainTexture_ST.xy + _MainTexture_ST.zw;
				float2 panner3 = ( 1.0 * _Time.y * appendResult6.xy + uv_MainTexture);
				float4 tex2DNode1 = tex2D( _MainTexture, panner3 );
				
				float2 texCoord7 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_18_0 = saturate( pow( ( ( ( 1.0 - texCoord7.y ) * texCoord7.y ) * 4.0 ) , _MaskRange ) );
...
Node;AmplifyShaderEditor.RangedFloatNode;5;-1084,151.5;Float;False;Property;_MainVPanner;Main VPanner;2;0;Create;True;0;0;0;False;0;False;0;-4.8;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;4;-1062,82.5;Float;False;Property;_MainUPanner;Main UPanner;1;0;Create;True;0;0;0;False;0;False;0;-1.6;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;1;-513,-153.5;Inherit;True;Property;_MainTexture;Main Texture;0;0;Create;True;0;0;0;False;0;False;-1;None;26d99dab8d9716843a7eae30e2412f1b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;23;-237.6335,-297.037;Float;False;Property;_MainIns;Main Ins;5;0;Create;True;0;0;0;False;0;False;0;20;1;20;0;1;FLOAT;0
...
WireConnection;74;2;27;0
WireConnection;74;3;28;0
ASEEND*/
//CHKSM=C18CB3D1B5EE265DF66DBED5A4FEADBB39CE1F40