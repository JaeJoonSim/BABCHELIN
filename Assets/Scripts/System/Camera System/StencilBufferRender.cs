...
public class StencilBufferRender : BaseMonoBehaviour
{
    ...
    private Camera _cam => base.gameObject.GetComponent<Camera>();
    ...
    private void CreateCommandBuffer()
    {
        ...
        _cmdBuffer.ClearRenderTarget(clearDepth: false, clearColor: true, Color.black);
        Shader shader = Shader.Find("Hidden/StencilToRT");
        _postProcessMat = new Material(shader);
        _ = _cam.cameraToWorldMatrix;
